...
//#include "../runtime/gc/roots/roots.h"
#ifndef EXTERNC
...
//the header param is used to record the type of each filed of this record.
//use "1" to record a pointer, use a "0" to record a non-pointer.
//LAB7:GC
